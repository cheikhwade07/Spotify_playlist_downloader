try:
    ...
    from pytubefix import Search
      ...
      print("pytubefix is not installed go to your command prompt and insert pip install pytubefix or search for another way to install it")
      quit()
import os
from spotipy_Github_function import show_tracks , select_a_playlist
